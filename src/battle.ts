...
function getRivalVariant(rivalType): TrainerVariant {
  switch (rivalType) {
  case RivalType.IVY:
    return TrainerVariant.FEMALE;
  case RivalType.FINN:
    return TrainerVariant.DEFAULT;
...
export const fixedBattles: FixedBattleConfigs = {
  ...
  [1]: new FixedBattleConfig().setBattleType(BattleType.TRAINER)
    .setGetTrainerFunc(scene => new Trainer(scene, TrainerType.RIVAL, getRivalVariant(scene.gameData.rivalType)  )),
  [25]: new FixedBattleConfig().setBattleType(BattleType.TRAINER)
    .setGetTrainerFunc(scene => new Trainer(scene, TrainerType.RIVAL_2, getRivalVariant(scene.gameData.rivalType)  )),
  [55]: new FixedBattleConfig().setBattleType(BattleType.TRAINER)
    .setGetTrainerFunc(scene => new Trainer(scene, TrainerType.RIVAL_3, getRivalVariant(scene.gameData.rivalType)  )),
  [95]: new FixedBattleConfig().setBattleType(BattleType.TRAINER)
    .setGetTrainerFunc(scene => new Trainer(scene, TrainerType.RIVAL_4, getRivalVariant(scene.gameData.rivalType)  )),
  [145]: new FixedBattleConfig().setBattleType(BattleType.TRAINER)
    .setGetTrainerFunc(scene => new Trainer(scene, TrainerType.RIVAL_5, getRivalVariant(scene.gameData.rivalType)  )),
  ...
  [195]: new FixedBattleConfig().setBattleType(BattleType.TRAINER)
    .setGetTrainerFunc(scene => new Trainer(scene, TrainerType.RIVAL_6, getRivalVariant(scene.gameData.rivalType)  ))
};
